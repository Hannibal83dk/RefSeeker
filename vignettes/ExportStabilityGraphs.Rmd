...
So far the only option is a bar graph depicting the stabilies from each algorithm.
...
The default orientation of the bars is horizontal. This seems to ease the readability of the target names. However, a vertical orientation is desired this is easily done by setting the orientation to "vertical"
<br>
