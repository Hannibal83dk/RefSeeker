---
title: "Stabilty Analysis - This article is outdated and need to be updated"
...
Keep in mind that by default, the x-axis is arranged using the RefFinder stability ranking, meaning that the sequence of targets on the x-axis will be arranged from most to least stable and might not be in the same order even in a multigraph, to change this default behaviour, see below for manual analysis and graph printing.
...
![](../inst/exdata/VignettesOutputs/RefSeeker_data_test_2022-09-12.png){width=30%}
...
inputData <- rs_loaddata("../inst/exdata/vignetteInputs/RefSeeker_data_test.xlsx")
```
